/*******************************************************************************
*
* Parser generated by RDP on Mar 17 2021 21:15:07 from rdp.bnf
*
*******************************************************************************/
#include <time.h>
#include "rdp_aux.h"
...
const char *rdp_tokens = "IGNORE\0"
  ...
  "'SET_SIZE'\0" "'SHOW_SKIPS'\0" "'STRING'\0" "'STRING_ESC'\0"
  "'SUFFIX'\0" "'SUPPRESS_BUILT_IN_ARGUMENTS'\0" "'SYMBOL_TABLE'\0"
  "'TAB_WIDTH'\0" "'TEXT_SIZE'\0" "'TITLE'\0" "'TREE'\0" "'USES'\0"
  "'['\0" "'[*'\0" "']'\0" "'^'\0" "'^^'\0" "'^^^'\0" "'^_'\0"
  "'{'\0" "'|'\0" "'}'\0" ;
...
static void rdp_set_initialise(void)
{
  ...
  set_assign_list(&dir_first, RDP_T_ANNOTATED_EPSILON_TREE,
    ...
    RDP_T_SYMBOL_TABLE, RDP_T_TAB_WIDTH, RDP_T_TEXT_SIZE, RDP_T_TITLE,
  ...
  set_assign_list(&rdp_dir_34_first, RDP_T_ANNOTATED_EPSILON_TREE,
    RDP_T_DERIVATION_TREE, RDP_T_EPSILON_TREE, RDP_T_SUPPRESS_BUILT_IN_ARGUMENTS,
    RDP_T_TREE, SET_END);
  set_assign_list(&rdp_dir_37_first, RDP_T_ANNOTATED_EPSILON_TREE,
    RDP_T_DERIVATION_TREE, RDP_T_EPSILON_TREE, RDP_T_SUPPRESS_BUILT_IN_ARGUMENTS,
    RDP_T_TREE, SET_END);
